...
export default function ActivitiesDashboard() {
  const [activeTab, setActiveTab] = useState<"school" | "grade" | "section" | "student">("school");
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex gap-3 mb-5 flex-wrap items-end">
        {(activeTab === "grade" || activeTab === "section" || activeTab === "student") && (
          <div>
        ...
        {(activeTab === "section" || activeTab === "student") && (
          <div>
