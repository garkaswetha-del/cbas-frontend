...
Call log:
  - waiting for locator('a:has-text("Teachers Appraisal"), a[href*="appraisal"]') to be visible
...
- generic [ref=e4]:
  - generic [ref=e5]:
    - generic [ref=e6]:
      - img "Wisdom Techno School" [ref=e7]
      - paragraph [ref=e8]: Competency Based Assessment System
    - generic [ref=e9]:
      ...
      - generic [ref=e11]:
        - generic [ref=e12]:
          ...
          - generic [ref=e14]:
            - generic [ref=e15]: ✉️
            - textbox "Enter your email" [ref=e16]: garkaswetha@gmail.com
        - generic [ref=e17]:
          - generic [ref=e18]: Password
          - generic [ref=e19]:
            - generic [ref=e20]: 🔒
            - textbox "Enter your password" [ref=e21]: swetha123
  ...
  - paragraph [ref=e28]: © 2025 Wisdom Techno School. All rights reserved.
```
...
> 27  |   await page.waitForSelector(
  ...
  121 | }
  122 | 
  123 | test.describe('E2E — Appraisal Excel Import (comprehensive)', () => {
  124 |   test.setTimeout(120000);
  125 | 
  126 |   // ══════════════════════════════════════════════════════════════
  127 |   // GROUP 1 — PANEL OPEN / CLOSE
```